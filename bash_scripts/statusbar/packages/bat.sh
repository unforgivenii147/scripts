...
update() {
    ...
    elif [ "$bat_text" -ge 50 ]; then bat_icon="" icon_color="^c
    elif [ "$bat_text" -ge 40 ]; then bat_icon="" icon_color="^c
    elif [ "$bat_text" -ge 30 ]; then bat_icon="" icon_color="^c
    elif [ "$bat_text" -ge 20 ]; then bat_icon="" icon_color="^c
    elif [ "$bat_text" -ge 10 ]; then bat_icon="" icon_color="^c
    else bat_icon="" icon_color="^c
    bat_text=""
